...
#define FIREBASE_HOST "gps-t3.firebaseio.com" //Thay bằng địa chỉ firebase của bạn
#define FIREBASE_AUTH "Wjac4fU69lbetVc1AwFyZ9Lvr7AJ2ThDjJzY880i" //Không dùng xác thực nên không đổi
...
//    uid = object.getString("uid");
    uid = "PJnsaLFaiaYI1r2cgxZuRSxW0KJ2";
    Serial.println("tadaz, sau khi lay userId");
    ...
    Serial.println("pushed new value");
